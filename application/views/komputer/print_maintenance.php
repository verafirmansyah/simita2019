...
<table width="615" >
  <tr>
    ...
    <div align="center" class="title">KARTU PEMELIHARAAN KOMPUTER</div></strong></u></td>    
  </tr>
 <tr>
<td width="607" font-size="10px" ><strong>
  <div align="center" class="title"></div></strong></td>
 </tr>
  <tr>
    <td id="noBorder"><table width="436" height="125" cellspacing="0" cellpadding="0" >
      ...
      <tr>
        <td width="115" id="noBorder">No. Aset</td>
        <td width="22" id="noBorder">:</td>
        <td width="297" id="noBorder"><?php echo $recordall['aset_hrd']; ?></td>
      </tr>
      <tr>
        <td id="noBorder">Merk / Tipe</td>
        <td id="noBorder">:</td>
        <td id="noBorder"><?php echo $recordall['nama_komputer']; ?> / <?php echo $recordall['tipe']; ?> </td>
      </tr>
      <tr>
        <td id="noBorder">Serial Number</td>
        <td id="noBorder">:</td>
        <td id="noBorder"><?php echo $recordall['serial_number']; ?> </td>
      </tr>
      <tr>
  ...
  <tr>
	...
	<tr>
		<td colspan='5' align='right'> <p>&nbsp;</p>
		  <p><?php $date = date('m/d/Y h:i:s a', time()); ?></p></td>
	</tr>
    </table></td>
  </tr>
</table>
