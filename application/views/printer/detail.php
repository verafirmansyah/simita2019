                      ...
                      <div class="tab-pane active" id="tab_1">
                        <div class="col-md-6 ">                        
                          ...
                          <br>
                            ...
                            <tr>
                              <td style="text-align:right">Status Sewa :</td>
                              <td><?php echo $recordall['isSewa']?></td>                    
                            </tr>
							              <tr>
                          ...
                          <a href="<?php echo site_url('printer'); ?>" class="btn btn-danger"><i class="fas fa-caret-square-left"></i> Kembali</a>
                        </div>
                      </div><!-- /.tab-pane -->
