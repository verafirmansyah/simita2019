...
<table width="615" >
  <tr>
    ...
    <div align="center" class="title">KARTU PERAWATAN PRINTER</div>
    </strong></u></td>    
  </tr>
 <tr>
<td width="607" font-size="10px" ><strong>
  ...
  <tr>
    <td id="noBorder"><table width="436" height="125" cellspacing="0" cellpadding="0" >
      ...
      <tr>
        <td id="noBorder">Jenis / Merk Printer</td>
        <td id="noBorder">:</td>
        <td id="noBorder"><?php echo $recordall['jenis_printer']; ?> / <?php echo $recordall['merk']; ?> </td>
      </tr>
      <tr>
