                    ...
                    <div class="box-body">                        
                        <div class="form-group">                                                
                          ...
                          <br>
                                ...
                                <?php 
                                  if ($record['status']=="Mutasi"){
                                    ...
                                    echo "<option value='Mutasi'>Mutasi</option>
                                        <option value='Buat Baru' selected>Buat Baru</option>";
                                  }
                                ?>      
                                </select>                                                              
                              </td>                    
                            ...
                            <tr>
                              <td style="text-align:right">Lokasi/ Tempat :</td>
                                <td>
                                <input type="text" name="lokasi" class="form-control" id="inputError" required oninvalid="setCustomValidity('Lokasi/Tempat Penempatan !')"
                                   oninput="setCustomValidity('')" placeholder="Tempat/ Lokasi" value="<?php echo $record['lokasi']; ?>" >
                                </td>
                            </tr>
                            <tr>
